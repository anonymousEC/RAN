...
test_all_o()
{
    ...
    ./start_client.sh -rdeo "${1}MB_repair" "${1}MB_dst" | tee "${2}/ode"
    ./start_client.sh -rdno "${1}MB_repair" "${1}MB_dst" | tee "${2}/odn"
    # # #Homogeneous Network and Full-node Recovery
    ./start_client.sh -rfto "${1}MB_repair" "${1}MB_dst" | tee "${2}/oft"
    ./start_client.sh -rfro "${1}MB_repair" "${1}MB_dst" | tee "${2}/ofr"
    ./start_client.sh -rfeo "${1}MB_repair" "${1}MB_dst" | tee "${2}/ofe"
    ./start_client.sh -rfno "${1}MB_repair" "${1}MB_dst" | tee "${2}/ofn"
}
