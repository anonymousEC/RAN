...
class StripedBlockReconstructor extends StripedReconstructor
  ...
  public void run() {
    try {
      ...
      LOG.info("RAN[StripedReconstructor]: HDFS ALLRepairTotalTime: [" + totalReconstruct + "us]  ["
  ...
  void reconstruct() throws IOException {
    // RAN-begin
    long totalReadReconstruct = 0;
    long totalDecodeReconstruct = 0;
    long totalWriteReconstruct = 0;
